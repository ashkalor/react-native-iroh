...
def add_nitrogen_files(spec)
  Pod::UI.puts "[NitroModules] Iroh is boosted by nitro!"
  ...
  spec.public_header_files = current_public_header_files + [
    ...
    "nitrogen/generated/ios/Iroh-Swift-Cxx-Bridge.hpp"
  ]
  ...
  spec.script_phases = current_script_phases + [{
    :name => 'Build Rust Library (iroh_rust)',
    :script => %Q{
      set -e
      ...
      echo "Building iroh_rust for $RUST_TARGET..."
      cd "$RUST_SRC_DIR"
      cargo build --release --target "$RUST_TARGET"

      mkdir -p "$RUST_LIB_DIR"
      cp "target/$RUST_TARGET/release/libiroh_rust.a" "$RUST_LIB_DIR/"
    },
  ...
  spec.vendored_libraries = current_vendored_libraries + [
    File.join(rust_lib_dir_relative, "libiroh_rust.a")
  ]
