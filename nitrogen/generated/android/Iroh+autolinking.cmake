...
# ```cmake
# include(${CMAKE_SOURCE_DIR}/../nitrogen/generated/android/Iroh+autolinking.cmake)
# ```

# Define a flag to check if we are building properly
add_definitions(-DBUILDING_IROH_WITH_GENERATED_CMAKE_PROJECT)
...
target_sources(
  ...
  Iroh PRIVATE
  # Autolinking Setup
  ../nitrogen/generated/android/IrohOnLoad.cpp
  # Shared Nitrogen C++ sources
  ../nitrogen/generated/shared/c++/HybridIrohSpec.cpp
  ../nitrogen/generated/shared/c++/HybridIrohSpecRust.cpp
...
set(NITRO_RUST_LIB_OUTPUT "${NITRO_RUST_LIB_DIR}/libIroh_rust.a")
...
add_custom_command(
  ...
  COMMAND ${CMAKE_COMMAND} -E copy
    "${NITRO_RUST_SRC_DIR}/target/${RUST_TARGET}/release/libIroh_rust.a"
...
add_custom_target(Iroh_rust_build DEPENDS ${NITRO_RUST_LIB_OUTPUT})

add_library(Iroh_rust STATIC IMPORTED)
set_target_properties(Iroh_rust PROPERTIES IMPORTED_LOCATION ${NITRO_RUST_LIB_OUTPUT})
add_dependencies(Iroh_rust Iroh_rust_build)
target_link_libraries(Iroh Iroh_rust)
