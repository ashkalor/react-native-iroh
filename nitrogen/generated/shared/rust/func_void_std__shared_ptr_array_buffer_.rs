//
// func_void_std__shared_ptr_array_buffer_.rs
...
/// FFI-safe wrapper for callback `Func_void_std__shared_ptr_ArrayBuffer_`.
///
...
#[repr(C)]
pub struct Func_void_std__shared_ptr_ArrayBuffer_ {
...
unsafe impl Send for Func_void_std__shared_ptr_ArrayBuffer_ {}
unsafe impl Sync for Func_void_std__shared_ptr_ArrayBuffer_ {}

impl Func_void_std__shared_ptr_ArrayBuffer_ {
    ...
    pub unsafe fn call(&self, chunk: NitroBuffer) {
        unsafe {
            (self.fn_ptr)(
                self.userdata,
                Box::into_raw(Box::new(chunk)) as *mut std::ffi::c_void,
            );
        }
    }
}

impl Drop for Func_void_std__shared_ptr_ArrayBuffer_ {
    fn drop(&mut self) {
        unsafe {
